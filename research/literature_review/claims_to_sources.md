# Claims-to-Sources Cross-Reference (Refined)
...
Every claim has been scoped conservatively to **avoid overstating what the empirical pipeline can prove**, and each reference is marked with its category (`core`, `background`, `extension`) and method status (`implemented`, `context only`, `future work`).

---

## 1. Dimensionality Reduction & Visualization Constraints

### Claim 1: "UMAP is used strictly for qualitative, auxiliary visualization. Its projected distances distort the true global and local geometries, making it mathematically invalid for quantitative morphological measurements."
*   **Supporting Literature:**
    *   **[chari2023specious](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L186-L197)** (Chari et al., 2023)  
        *   *Category:* `core` | *Method Status:* `implemented` (as constraint justification)  
...
*   **Supporting Literature:**
    *   **[radovanovic2010hubness](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L80-L90)** (Radovanović et al., 2010)  
        *   *Category:* `core` | *Method Status:* `implemented` (theory and localized indegree Gini)  
    ...
    *   **[feldbauer2019skhubness](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L91-L101)** (Feldbauer et al., 2019)  
        *   *Category:* `extension` | *Method Status:* `future work`  
...
*   **Supporting Literature:**
    *   **[priem2022openalex](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L1-L10)** (Priem et al., 2022)  
        *   *Category:* `core` | *Method Status:* `implemented`  
...
### Claim 4: "SPECTER2 embeddings effectively capture both semantic text context and citation-informed relatedness, providing a dense vector coordinate space for document-level science mapping."
*   **Supporting Literature:**
...
*   **Supporting Literature:**
    *   **[borner2003visualizing](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L21-L33)** (Börner et al., 2003)  
        *   *Category:* `background` | *Method Status:* `context only`  
...
### Claim 8: "Clustering is strictly an exploratory tool to identify morphological typologies based on the 11 metric profiles. No clustering algorithm represents a 'natural, perfect partition' of scientific knowledge."
*   **Supporting Literature:**
    *   **[kleinberg2002clustering](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L164-L174)** (Kleinberg, 2002)  
        *   *Category:* `core` | *Method Status:* `implemented` (as conceptual boundary)  
        *   *Thesis Support:* Proves the mathematical impossibility of a perfect clustering algorithm.
    *   **[arthur2007kmeans](file:///c:/Users/Z0058EYW/Workspace/TFM/research/literature_review/candidate_references.bib#L341-L350)** (Arthur & Vassilvitskii, 2007)  
        *   *Category:* `core` | *Method Status:* `implemented`  
        *   *Thesis Support:* Formulates k-means++ seeding, which is implemented in our exploratory clustering of subfield profiles.
