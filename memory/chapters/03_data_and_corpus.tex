...
For a subfield \(s\), let \(Z_s=\{z_i:i\in s\}\) be the set of normalized document embeddings and \(c_s=n_s^{-1}\sum_{i\in s}z_i\) its centroid. The active structural morphology profile contains eight metrics grouped into four families: global dispersion, local density, hubness, and spectral structure. Appendix~\ref{app:metric-formulations} records the formulas.
