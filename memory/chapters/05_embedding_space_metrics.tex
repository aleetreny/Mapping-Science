...
\begin{figure}[H]
\centering
\caption[Metric families as field-shape grammar]{Metric families as a grammar of field shape. The eleven-metric core separates five questions about a subfield's paper cloud so that dispersion, local density, hubness, spectral structure, and temporal movement are not collapsed into one score.}
