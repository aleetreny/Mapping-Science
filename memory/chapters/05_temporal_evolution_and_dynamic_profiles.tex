...
\includegraphics[width=\textwidth]{figures/fig_05_domain_temporal_trajectories.pdf}
\end{figure}
...
\includegraphics[width=\textwidth,height=0.80\textheight,keepaspectratio]{figures/fig_05_field_temporal_delta_heatmap.pdf}
\end{figure}
...
\includegraphics[width=0.93\textwidth]{figures/fig_05_most_dynamic_subfields.pdf}
\end{figure}
...
\includegraphics[width=\textwidth]{figures/fig_05_centroid_drift_extremes.pdf}
\end{figure}
...
\includegraphics[width=\textwidth]{figures/fig_05_dynamic_typology_profile_heatmap.pdf}
\end{figure}
