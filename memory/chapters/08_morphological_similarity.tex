...
\begin{figure}[H]
\centering
\caption[Domain-pair morphological distance structure]{Domain-pair morphological distance structure. Panel A reports median field-pair distances for each pair of OpenAlex domains. Diagonal cells are within-domain medians, computed from pairs of fields in the same domain and excluding self-comparisons; off-diagonal cells are between-domain medians. Panel B counts fields whose nearest morphological neighbor lies inside or outside their own domain.}
