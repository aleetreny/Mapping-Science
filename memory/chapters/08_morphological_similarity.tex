% Chapter 6: Morphological Similarity and Taxonomy
...
\begin{figure}[H]
\centering
\caption[Strongest field-level convergence and divergence pairs]{Strongest field-level convergence and divergence pairs. Each line compares initial and final windowed profile distances; signed labels identify the largest decreases and increases in morphological distance.}
