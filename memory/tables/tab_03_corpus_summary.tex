...
\end{tabular}
\par\vspace{0.2cm}
\footnotesize\textit{Note.} Counts use the synchronized \texttt{2000\_2024\_400py} corpus snapshot. The analysis embedding rows refer to the eligible subset used by downstream morphology metrics.
\end{table}
