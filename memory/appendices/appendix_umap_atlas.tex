...
A broader interactive project viewer is available at:
\begin{center}
\footnotesize\url{https://aleetreny.github.io/Mapping-Science/}
\end{center}
It can be used to explore additional discipline and subfield shapes beyond the selected cases included in this appendix.
