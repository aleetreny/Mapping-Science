...
\begin{figure}[p]
    ...
    \caption[Illustrative UMAP atlas: Human Factors and Ergonomics]{%
        ...
        the atypical profile behavior discussed in the thesis.}
...
\begin{figure}[p]
    ...
    \caption[Illustrative UMAP atlas: Computer Vision and Pattern Recognition]{%
        ...
        discussion of novelty and movement.}
...
\begin{figure}[p]
    ...
    \caption[Illustrative UMAP atlas: Signal Processing]{%
        ...
        novelty-oriented Computer Science cases.}
...
\begin{figure}[p]
    ...
    \caption[Illustrative UMAP atlas: General Materials Science]{%
        ...
        atlas and illustrates why morphology is not reducible to a single centroid.}
