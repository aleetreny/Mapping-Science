...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-local", default="/kaggle/working/embeddings/specter2_v1")
    parser.add_argument("--output-remote", default="gdrive:TFM/openalex_subfields/embeddings/specter2_v1")
