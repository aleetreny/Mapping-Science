...
def main() -> None:
    ...
    summary = {
        ...
        "subfields_below_3000_papers": subfields_below_3000,
        "subfields_below_500_papers": subfields_below_500,
    ...
    report_lines = [
        ...
        f"- Subfields below 3,000 papers: {subfields_below_3000}",
        f"- Subfields below 500 papers: {subfields_below_500}",
        "",
